...
const Header = () => {
  ...
  return <nav onClick={()=> toggleHidden(!isHidden)} id="header" className="fixed w-full z-10 top-0 bg-white border-b border-gray-400">
           <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-4">
              ...
              <div className="block lg:hidden pr-4">
                 <button onClick={(e) => {toggleHidden(!isHidden); e.stopPropagation();}} id="nav-toggle" className="flex items-center px-3 py-2 border rounded text-gray-500 border-gray-600 hover:text-gray-900 hover:border-purple-500 appearance-none focus:outline-none">
              ...
              <div className={`w-full flex-grow lg:flex  lg:content-center lg:items-center lg:w-auto ${isHidden ? "hidden" : ""} lg:block mt-2 lg:mt-0 z-20`} id="nav-content">
                 <div className="flex-1 w-full mx-auto max-w-sm content-center py-4 lg:py-0">
                    <div onClick={(e) => e.stopPropagation()} className="relative pull-right pl-4 pr-4 md:pr-0">
